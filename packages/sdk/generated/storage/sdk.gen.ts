...
export class Sdk extends HeyApiClient {
     ...
     */
    public listMentionableBots<ThrowOnError extends boolean = false>(options?: Options<ListMentionableBotsData, ThrowOnError>): RequestResult<ListMentionableBotsResponses, ListMentionableBotsErrors, ThrowOnError> {
        return (options?.client ?? this.client).get<ListMentionableBotsResponses, ListMentionableBotsErrors, ThrowOnError>({ url: '/bots/mentionable', ...options });
    }
     ...
     */
    public listPersonas<ThrowOnError extends boolean = false>(options?: Options<ListPersonasData, ThrowOnError>): RequestResult<ListPersonasResponses, ListPersonasErrors, ThrowOnError> {
        return (options?.client ?? this.client).get<ListPersonasResponses, ListPersonasErrors, ThrowOnError>({ url: '/personas', ...options });
    }
    
    /**
     * Handler for `POST /personas`.
     */
    public createPersona<ThrowOnError extends boolean = false>(options: Options<CreatePersonaData, ThrowOnError>): RequestResult<CreatePersonaResponses, CreatePersonaErrors, ThrowOnError> {
        return (options.client ?? this.client).post<CreatePersonaResponses, CreatePersonaErrors, ThrowOnError>({
            url: '/personas',
            ...options,
            headers: {
                'Content-Type': 'application/json',
     ...
     */
    public deletePersona<ThrowOnError extends boolean = false>(options: Options<DeletePersonaData, ThrowOnError>): RequestResult<DeletePersonaResponses, DeletePersonaErrors, ThrowOnError> {
        return (options.client ?? this.client).delete<DeletePersonaResponses, DeletePersonaErrors, ThrowOnError>({ url: '/personas/{bot_id}', ...options });
    }
    
    /**
     * Handler for `GET /personas/{bot_id}`.
     */
    public getPersona<ThrowOnError extends boolean = false>(options: Options<GetPersonaData, ThrowOnError>): RequestResult<GetPersonaResponses, GetPersonaErrors, ThrowOnError> {
        return (options.client ?? this.client).get<GetPersonaResponses, GetPersonaErrors, ThrowOnError>({ url: '/personas/{bot_id}', ...options });
    }
    
    /**
     * Handler for `PATCH /personas/{bot_id}`.
     */
    public patchPersona<ThrowOnError extends boolean = false>(options: Options<PatchPersonaData, ThrowOnError>): RequestResult<PatchPersonaResponses, PatchPersonaErrors, ThrowOnError> {
        return (options.client ?? this.client).patch<PatchPersonaResponses, PatchPersonaErrors, ThrowOnError>({
            url: '/personas/{bot_id}',
            ...options,
            headers: {
                'Content-Type': 'application/json',
